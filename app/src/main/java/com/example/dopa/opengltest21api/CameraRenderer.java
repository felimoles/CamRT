...
import com.example.dopa.opengltest21api.filterCRT;
import com.example.dopa.opengltest21api.OriginalFilter;
import com.example.dopa.opengltest21api.filterCRT2;
import com.example.dopa.opengltest21api.filterCRT_v1_0;


public class CameraRenderer extends Activity implements Runnable, TextureView.SurfaceTextureListener {
    ...
    public void run() {
        ...
        //Fix Aspect ratio/ Rotation


        // Setup camera filters map
        cameraFilterMap.append(R.id.filter0, new OriginalFilter(context));
        cameraFilterMap.append(R.id.filter1, new filterCRT(context));
        cameraFilterMap.append(R.id.filter2, new filterCRT2(context));
        cameraFilterMap.append(R.id.filter3, new filterCRT_v1_0(context));
        ...
        while (!Thread.currentThread().isInterrupted()) {
            try {
                ...
                // Draw camera preview (se cambia es aspect ratio)
